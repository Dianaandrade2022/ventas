...
<div class="modal fade" id="additionalCostsModal" tabindex="-1" aria-labelledby="additionalCostsModalLabel" style="display: none;" role="dialog">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <h1 class="text-center mt-4">Datos de la cotización</h1>
            <div class="row d-flex justify-content-between">
                ...
                <div class="mx-5">
                    <div id="acciones_venta" class="form-group">
                        <a href="#" class="btn btn-danger mx-2" id="cancel_estimate_btn"><i class="fa fa-times" aria-hidden="true"></i> Anular </a>
                        <a href="#" class="btn btn-primary" id="estimate_btn"><i class="fa fa-dollar"></i> Generar Cotización</a>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr style="background-color:#4B75F2; color: #fff">
                            <th colspan="2" style="max-width:fit-content;" >Nombre / Código del producto</th>
                            <th>Descripción</th>
                            <th>Stock</th>
                            <th>Precio</th>
                        ...
                        <tr>
                            <td><input class="form-control" style="max-width:fit-content;" type="text" name="budget_product_code" id="budget_product_code"></td>
                            <td id="name" colspan="2">-</td>
                            <td id="stock">-</td>
                            <td id="price">0.00</td>
                            <td><input class="form-control" type="text" name="product_quantity" id="product_quantity" value="0" min="1" disabled></td>
                            <td><input class="form-control" type="text" name="cost" id="cost" value="0.00" min="1" ></td>
