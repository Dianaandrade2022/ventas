<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="SalesController.php?name=sale_new" class="btn btn-primary">Nueva Cotizacion</a>
    </div>
    <hr class="mb-5">
    <div class="row">
        <div class="col-lg-12">
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="table">
                    ...
                    <tbody>
    <?php
    $rows = getStimates(); // Obtén todas las ventas
    foreach ($rows as $row) :
        ...
        <tr>
            ...
            <td class="text-center">
                <div class="d-flex flex-direction-row justify-content-center">
                    <button type="button" class="btn btn-primary download_estimate" total="<?= htmlspecialchars($row['total'] ?? 0) ?>" clientId="<?= htmlspecialchars($row['clientId'] ?? '') ?>" estimateId="<?= htmlspecialchars($row['id'] ?? '') ?>">Descargar</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <for method="POST">
                    ...
                    <input type="hidden" value="<?= htmlspecialchars($row['id'] ?? '') ?>" name="estimateId" id="estimateId">
                    ...
                    <button id="updatestatusestimate" class="btn btn-primary">Guardar cambios</button>
                </form>
            </div>
        </div>
    </div>
